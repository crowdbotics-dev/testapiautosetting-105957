...
## Project Structure
    ...
    ├── testapiautosetting_105957  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_105957`
...
2. Clone this repo and `cd testapiautosetting_105957`
